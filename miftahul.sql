...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Mar 2021 pada 18.18
...
INSERT INTO `gambar` (`id`, `picture`, `ket`, `created_at`, `updated_at`) VALUES
(1, 'about-01.jpg', 'gambar 1', NULL, NULL),
(2, 'pendaftaran.jpg', 'gambar 2', NULL, NULL),
(3, '3.jpg', 'gambar 3', NULL, NULL),
(4, 'header1.png', 'gambar 4', NULL, NULL),
(5, 'psb.jpg', 'gambar 5', NULL, NULL),
(6, 'header.jpg', 'gambar 6', NULL, NULL),
(7, 'left.png', 'gambar7', NULL, NULL);
...
(2, 'admin miftahul ridwan', 'miftahul@gmail.com', '$2y$10$opkoBrY3IJGnkETJUgBAv.p22.b2CreiLaAGC.tLE9lCTOXnMDYS2', NULL, NULL);
